...
.section-heading, .tabs-content{
  ...
  <header class="main-header clearfix" role="header">
    ...
    <nav id="menu" class="main-nav" role="navigation">
      <ul class="main-menu">
        ...
        <li><a href="#courses_1">Courses</a></li>
        ...
        <li><a href="home" class="external">User: {{ Auth::user()->name }}</a></li>
      </ul>
    </nav>
  </header>
  ...
  <section class="section courses" data-section="section4" id="courses_1">
